...
class ViewController: UIViewController {
    ...
    let googleApiRequestUrl = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyDwM5YGbWpME6vHZ_RYf2QuxPoXZTS0P2s&channelId=UCKsvjO03BYgOaKcHNVsWz8Q&part=snippet,id&order=date&maxResults=20"
